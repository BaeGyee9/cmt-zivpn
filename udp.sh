...
curl -fsSL -o /etc/zivpn/web.py "https://raw.githubusercontent.com/BaeGyee9/cmt-zivpn/main/templates/web.py"
if [ $? -ne 0 ]; then
...
curl -fsSL -o /etc/zivpn/bot.py "https://raw.githubusercontent.com/BaeGyee9/cmt-zivpn/main/telegram/bot.py"
if [ $? -ne 0 ]; then
...
# ufw allow 19437/tcp >/dev/null 2>&1 || true
...
echo -e "${C}🌐 WEB PANEL:${Z} ${Y}http://$IP:19437${Z}"
